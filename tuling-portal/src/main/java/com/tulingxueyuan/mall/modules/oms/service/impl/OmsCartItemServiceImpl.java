...
public class OmsCartItemServiceImpl extends ServiceImpl<OmsCartItemMapper, OmsCartItem> implements OmsCartItemService {
    ...
    public Integer getCarProdutSum() {
        ...
        List<OmsCartItem> memberItems = cartItemMapper.getMemberItems();
//        ArrayList<Object> memberIdList = new ArrayList<>();
//        if (memberItems != null){
//            for (OmsCartItem memberItem : memberItems) {
//                Long id = memberItem.getMemberId();
//                memberIdList.add(id);
//            }
//        }
        List<Long> memberIdList = memberItems.stream()
                .map(OmsCartItem::getMemberId).collect(Collectors.toList());
